================================================================
=== I言語 Ver37 バージョンアップ情報 
================================================================
（★=非互換発生、■＝EXE修正、▲＝支援プログラム修正、●＝新機能追加）

===================================================================
■(2026-02-11)PROGRAM=INPUTでDATA={K}が一つも無いと更新を何も処理しないで、正常に処理したと成ってしまうのでエラーに改め。VER37.10.0.0.3
●(2025-12-21)&X1.WORK_DATA_DEFINEのテーブル変数を新設しました、PROGAM{0,テーブル名,?&X1.WORK_DATA_DEFINE?}とする事で作業エリアを事前に定義する必要を無くしました。VER37.10.0.2
■(2025-12-08)小数点以下の表示は無用な0は表示しないように成っていますが、SQL=での表示項目のみ、入力時点で無用な0を表示するので、表示しないように変更しました。VER37.10.0.0.1
