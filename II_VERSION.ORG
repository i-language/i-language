...
// 共有クラス(STATIC)
//#if IMENU||IMTEST||ITIME||IPRINT||ICHART||ICHART2||IROOT||ISRVC||ISETUP||IPAPER //TEST
...
{
//####################( IMENU||IMTEST,ITIMEのバージョンアップ時変更 )###############
//###★注意：変更時オリジナルのZZZZZZ_ETC_TABLE,ZZZZZZ_@,ZZZZZZ_VERSION2を変更しインストール環境を再構築する事。###
//#I言語のバージョン2             (111122333) #####
public readonly String VERSION2_S="001000006";
//############################################################################
public readonly int VERSION1=38; //i-language Version(38)
...
{
//#if IMENU||IMTEST||ITIME||IPRINT||ICHART
